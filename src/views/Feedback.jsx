...
const Feedback = () => {
  ...
  const athleteIframe =
    ...
    '<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScsYG_c3nktyWDeucwukPxdrn5T13Zi9jhsWoy0Fu0qUYqFFw/viewform?embedded=true" width="1040" height="2110" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>'
  const doctorIframe =
    ...
    <div className="wrapper">
      <div className="card frame" style={{ height: '2450px', width: '1070px' }}>
        <div className="card-header">
          <h4 className="card-header-title header">Geribildirim Formu</h4>
        </div>
        <form className="feedback" id="feedback">
          <div className="mb-3">
            <p>
              <b>
                Karar verme destek uygulamasını değerlendirmek için oluşturulan
                geribildirim formunu doldurmak için lütfen rolünüze uygun olan
                seçeneğe tıklayınız.
              </b>
            </p>
            <p>
              <b>
                Eğer formu daha önce doldurduysanız yeniden doldurmanıza gerek
                yok.
              </b>
            </p>
          </div>
          ...
          >
            ...
            <button
              ...
              className="button"
            >
              Sağlık Uzmanı Geribildirim Formu
            </button>
          </div>
